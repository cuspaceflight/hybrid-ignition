...
/*
    Board identifier
*/
#define BOARD_IGNITION
#define BOARD_NAME                     "ignition"
...
#define GPIOA_UART_MAIN_TX             9U
#define GPIOA_UART_MAIN_RX             10U
...
#define GPIOB_CH1_FIRE                 1U
#define GPIOB_CH2_FIRE                 2U
...
#define GPIOB_ARM_GRN                  12U
#define GPIOB_ARM_RED                  13U
#define GPIOB_PIN14                    14U
#define GPIOB_PIN15                    15U

#define GPIOC_CH1_CONT                 0U
#define GPIOC_CH2_CONT                 1U
#define GPIOC_CH3_CONT                 2U
#define GPIOC_CH4_CONT                 3U
#define GPIOC_CH5_CONT                 4U
#define GPIOC_PIN5                     5U
#define GPIOC_PIN6                     6U
#define GPIOC_STATUS                   7U
...
#define GPIOE_ARM_SUPPLY               2U
#define GPIOE_PIN3                     3U
#define GPIOE_PIN4                     4U
#define GPIOE_PIN5                     5U
#define GPIOE_PIN6                     6U
#define GPIOE_CH3_FIRE                 7U
#define GPIOE_CH4_FIRE                 8U
#define GPIOE_CH5_FIRE                 9U
...
*/
#define LINE_ARM_GRN                   PAL_LINE(GPIOB, 12U)
#define LINE_ARM_RED                   PAL_LINE(GPIOB, 13U)
#define LINE_ARM_SUPPLY                PAL_LINE(GPIOE, 2U)
#define LINE_CH1_CONT                  PAL_LINE(GPIOC, 0U)
#define LINE_CH1_FIRE                  PAL_LINE(GPIOB, 1U)
#define LINE_CH2_CONT                  PAL_LINE(GPIOC, 1U)
#define LINE_CH2_FIRE                  PAL_LINE(GPIOB, 2U)
#define LINE_CH3_CONT                  PAL_LINE(GPIOC, 2U)
#define LINE_CH3_FIRE                  PAL_LINE(GPIOE, 7U)
#define LINE_CH4_CONT                  PAL_LINE(GPIOC, 3U)
#define LINE_CH4_FIRE                  PAL_LINE(GPIOE, 8U)
#define LINE_CH5_CONT                  PAL_LINE(GPIOC, 4U)
#define LINE_CH5_FIRE                  PAL_LINE(GPIOE, 9U)
...
#define LINE_PSU_MON                   PAL_LINE(GPIOA, 1U)
#define LINE_STATUS                    PAL_LINE(GPIOC, 7U)
#define LINE_SWCLK                     PAL_LINE(GPIOA, 14U)
#define LINE_SWDIO                     PAL_LINE(GPIOA, 13U)
#define LINE_UART_MAIN_RX              PAL_LINE(GPIOA, 10U)
#define LINE_UART_MAIN_TX              PAL_LINE(GPIOA, 9U)
 ...
 * PA7  - PIN7                         (unused).
 * PA8  - PIN8                         (unused).
 * PA9  - UART_MAIN_TX                 (af7).
 * PA10 - UART_MAIN_RX                 (af7).
 * PA11 - PIN11                        (unused).
 * PA12 - PIN12                        (unused).
 * PA13 - SWDIO                        (af0).
...
#define VAL_GPIOA_MODER                (PIN_MODE_INPUT(GPIOA_PIN0) | \
                                        ...
                                        PIN_MODE_ALTERNATE(GPIOA_UART_MAIN_TX) | \
                                        PIN_MODE_ALTERNATE(GPIOA_UART_MAIN_RX) | \
...
#define VAL_GPIOA_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOA_PIN0) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_PSU_MON) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOA_UART_MAIN_TX) | \
                                        PIN_OTYPE_PUSHPULL(GPIOA_UART_MAIN_RX) | \
...
#define VAL_GPIOA_OSPEEDR              (PIN_OSPEED_HIGH(GPIOA_PIN0) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOA_UART_MAIN_TX) | \
                                        PIN_OSPEED_HIGH(GPIOA_UART_MAIN_RX) | \
...
#define VAL_GPIOA_PUPDR                (PIN_PUPD_PULLUP(GPIOA_PIN0) | \
                                        PIN_PUPD_FLOATING(GPIOA_PSU_MON) | \
                                        ...
                                        PIN_PUPD_PULLUP(GPIOA_UART_MAIN_TX) | \
                                        PIN_PUPD_PULLUP(GPIOA_UART_MAIN_RX) | \
...
#define VAL_GPIOA_ODR                  (PIN_OD_HIGH(GPIOA_PIN0) | \
                                        ...
                                        PIN_OD_HIGH(GPIOA_UART_MAIN_TX) | \
                                        PIN_OD_HIGH(GPIOA_UART_MAIN_RX) | \
...
#define VAL_GPIOA_AFRH                 (PIN_AFIO_AF(GPIOA_PIN8, 0U) | \
                                        PIN_AFIO_AF(GPIOA_UART_MAIN_TX, 7U) | \
                                        PIN_AFIO_AF(GPIOA_UART_MAIN_RX, 7U) | \
 ...
 *
 * PB0  - PIN0                         (unused).
 * PB1  - CH1_FIRE                     (output pushpull startlow pulldown).
 * PB2  - CH2_FIRE                     (output pushpull startlow pulldown).
 * PB3  - PIN3                         (unused).
 * PB4  - PIN4                         (unused).
 * PB5  - PIN5                         (unused).
 * PB6  - PIN6                         (unused).
 * PB7  - PIN7                         (unused).
 * PB8  - I2C1_SCL                     (af4 opendrain).
 * PB9  - I2C1_SDA                     (af4 opendrain).
 * PB10 - I2C2_SCL                     (af4 opendrain).
 * PB11 - I2C2_SDA                     (af4 opendrain).
 * PB12 - ARM_GRN                      (output pushpull startlow).
 * PB13 - ARM_RED                      (output pushpull startlow).
 * PB14 - PIN14                        (unused).
 * PB15 - PIN15                        (unused).
*/
#define VAL_GPIOB_MODER                (PIN_MODE_INPUT(GPIOB_PIN0) | \
                                        PIN_MODE_OUTPUT(GPIOB_CH1_FIRE) | \
                                        PIN_MODE_OUTPUT(GPIOB_CH2_FIRE) | \
                                        ...
                                        PIN_MODE_OUTPUT(GPIOB_ARM_GRN) | \
                                        PIN_MODE_OUTPUT(GPIOB_ARM_RED) | \
                                        PIN_MODE_INPUT(GPIOB_PIN14) | \
                                        PIN_MODE_INPUT(GPIOB_PIN15))

#define VAL_GPIOB_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOB_PIN0) | \
                                        PIN_OTYPE_PUSHPULL(GPIOB_CH1_FIRE) | \
                                        PIN_OTYPE_PUSHPULL(GPIOB_CH2_FIRE) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOB_ARM_GRN) | \
                                        PIN_OTYPE_PUSHPULL(GPIOB_ARM_RED) | \
                                        PIN_OTYPE_PUSHPULL(GPIOB_PIN14) | \
                                        PIN_OTYPE_PUSHPULL(GPIOB_PIN15))

#define VAL_GPIOB_OSPEEDR              (PIN_OSPEED_HIGH(GPIOB_PIN0) | \
                                        PIN_OSPEED_HIGH(GPIOB_CH1_FIRE) | \
                                        PIN_OSPEED_HIGH(GPIOB_CH2_FIRE) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOB_ARM_GRN) | \
                                        PIN_OSPEED_HIGH(GPIOB_ARM_RED) | \
                                        PIN_OSPEED_HIGH(GPIOB_PIN14) | \
                                        PIN_OSPEED_HIGH(GPIOB_PIN15))

#define VAL_GPIOB_PUPDR                (PIN_PUPD_PULLUP(GPIOB_PIN0) | \
                                        PIN_PUPD_PULLDOWN(GPIOB_CH1_FIRE) | \
                                        PIN_PUPD_PULLDOWN(GPIOB_CH2_FIRE) | \
                                        ...
                                        PIN_PUPD_PULLUP(GPIOB_I2C1_SCL) | \
                                        PIN_PUPD_PULLUP(GPIOB_I2C1_SDA) | \
                                        PIN_PUPD_PULLUP(GPIOB_I2C2_SCL) | \
                                        PIN_PUPD_PULLUP(GPIOB_I2C2_SDA) | \
                                        PIN_PUPD_PULLUP(GPIOB_ARM_GRN) | \
                                        PIN_PUPD_PULLUP(GPIOB_ARM_RED) | \
                                        PIN_PUPD_PULLUP(GPIOB_PIN14) | \
                                        PIN_PUPD_PULLUP(GPIOB_PIN15))

#define VAL_GPIOB_ODR                  (PIN_OD_HIGH(GPIOB_PIN0) | \
                                        PIN_OD_LOW(GPIOB_CH1_FIRE) | \
                                        PIN_OD_LOW(GPIOB_CH2_FIRE) | \
                                        PIN_OD_HIGH(GPIOB_PIN3) | \
                                        PIN_OD_HIGH(GPIOB_PIN4) | \
                                        PIN_OD_HIGH(GPIOB_PIN5) | \
                                        PIN_OD_HIGH(GPIOB_PIN6) | \
                                        PIN_OD_HIGH(GPIOB_PIN7) | \
                                        PIN_OD_HIGH(GPIOB_I2C1_SCL) | \
                                        PIN_OD_HIGH(GPIOB_I2C1_SDA) | \
                                        PIN_OD_HIGH(GPIOB_I2C2_SCL) | \
                                        PIN_OD_HIGH(GPIOB_I2C2_SDA) | \
                                        PIN_OD_LOW(GPIOB_ARM_GRN) | \
                                        PIN_OD_LOW(GPIOB_ARM_RED) | \
                                        PIN_OD_HIGH(GPIOB_PIN14) | \
                                        PIN_OD_HIGH(GPIOB_PIN15))

#define VAL_GPIOB_AFRL                 (PIN_AFIO_AF(GPIOB_PIN0, 0U) | \
                                        PIN_AFIO_AF(GPIOB_CH1_FIRE, 0U) | \
                                        PIN_AFIO_AF(GPIOB_CH2_FIRE, 0U) | \
...
#define VAL_GPIOB_AFRH                 (PIN_AFIO_AF(GPIOB_I2C1_SCL, 4U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOB_ARM_GRN, 0U) | \
                                        PIN_AFIO_AF(GPIOB_ARM_RED, 0U) | \
 ...
 *  GPIOC setup:
 *
 * PC0  - CH1_CONT                     (analog floating).
 * PC1  - CH2_CONT                     (analog floating).
 * PC2  - CH3_CONT                     (analog floating).
 * PC3  - CH4_CONT                     (analog floating).
 * PC4  - CH5_CONT                     (analog floating).
 * PC5  - PIN5                         (unused).
 * PC6  - PIN6                         (unused).
 * PC7  - STATUS                       (output pushpull startlow).
 * PC8  - PIN8                         (unused).
 * PC9  - PIN9                         (unused).
 * PC10 - PIN10                        (unused).
 * PC11 - PIN11                        (unused).
 ...
 * PC15 - PIN15                        (unused).
*/
#define VAL_GPIOC_MODER                (PIN_MODE_ANALOG(GPIOC_CH1_CONT) | \
                                        PIN_MODE_ANALOG(GPIOC_CH2_CONT) | \
                                        PIN_MODE_ANALOG(GPIOC_CH3_CONT) | \
                                        PIN_MODE_ANALOG(GPIOC_CH4_CONT) | \
                                        PIN_MODE_ANALOG(GPIOC_CH5_CONT) | \
...
#define VAL_GPIOC_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOC_CH1_CONT) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH2_CONT) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH3_CONT) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH4_CONT) | \
                                        PIN_OTYPE_PUSHPULL(GPIOC_CH5_CONT) | \
...
#define VAL_GPIOC_OSPEEDR              (PIN_OSPEED_HIGH(GPIOC_CH1_CONT) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH2_CONT) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH3_CONT) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH4_CONT) | \
                                        PIN_OSPEED_HIGH(GPIOC_CH5_CONT) | \
...
#define VAL_GPIOC_PUPDR                (PIN_PUPD_FLOATING(GPIOC_CH1_CONT) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH2_CONT) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH3_CONT) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH4_CONT) | \
                                        PIN_PUPD_FLOATING(GPIOC_CH5_CONT) | \
...
#define VAL_GPIOC_ODR                  (PIN_OD_HIGH(GPIOC_CH1_CONT) | \
                                        PIN_OD_HIGH(GPIOC_CH2_CONT) | \
                                        PIN_OD_HIGH(GPIOC_CH3_CONT) | \
                                        PIN_OD_HIGH(GPIOC_CH4_CONT) | \
                                        PIN_OD_HIGH(GPIOC_CH5_CONT) | \
...
#define VAL_GPIOC_AFRL                 (PIN_AFIO_AF(GPIOC_CH1_CONT, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CH2_CONT, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CH3_CONT, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CH4_CONT, 0U) | \
                                        PIN_AFIO_AF(GPIOC_CH5_CONT, 0U) | \
 ...
 * PE0  - PIN0                         (unused).
 * PE1  - PIN1                         (unused).
 * PE2  - ARM_SUPPLY                   (output pushpull startlow pulldown).
 * PE3  - PIN3                         (unused).
 * PE4  - PIN4                         (unused).
 * PE5  - PIN5                         (unused).
 * PE6  - PIN6                         (unused).
 * PE7  - CH3_FIRE                     (output pushpull startlow pulldown).
 * PE8  - CH4_FIRE                     (output pushpull startlow pulldown).
 * PE9  - CH5_FIRE                     (output pushpull startlow pulldown).
 * PE10 - PIN10                        (unused).
 * PE11 - PIN11                        (unused).
 * PE12 - PIN12                        (unused).
 * PE13 - PIN13                        (unused).
...
#define VAL_GPIOE_MODER                (PIN_MODE_INPUT(GPIOE_PIN0) | \
                                        ...
                                        PIN_MODE_OUTPUT(GPIOE_ARM_SUPPLY) | \
                                        PIN_MODE_INPUT(GPIOE_PIN3) | \
                                        PIN_MODE_INPUT(GPIOE_PIN4) | \
                                        PIN_MODE_INPUT(GPIOE_PIN5) | \
                                        PIN_MODE_INPUT(GPIOE_PIN6) | \
                                        PIN_MODE_OUTPUT(GPIOE_CH3_FIRE) | \
                                        PIN_MODE_OUTPUT(GPIOE_CH4_FIRE) | \
                                        PIN_MODE_OUTPUT(GPIOE_CH5_FIRE) | \
...
#define VAL_GPIOE_OTYPER               (PIN_OTYPE_PUSHPULL(GPIOE_PIN0) | \
                                        ...
                                        PIN_OTYPE_PUSHPULL(GPIOE_ARM_SUPPLY) | \
                                        PIN_OTYPE_PUSHPULL(GPIOE_PIN3) | \
                                        PIN_OTYPE_PUSHPULL(GPIOE_PIN4) | \
                                        PIN_OTYPE_PUSHPULL(GPIOE_PIN5) | \
                                        PIN_OTYPE_PUSHPULL(GPIOE_PIN6) | \
                                        PIN_OTYPE_PUSHPULL(GPIOE_CH3_FIRE) | \
                                        PIN_OTYPE_PUSHPULL(GPIOE_CH4_FIRE) | \
                                        PIN_OTYPE_PUSHPULL(GPIOE_CH5_FIRE) | \
...
#define VAL_GPIOE_OSPEEDR              (PIN_OSPEED_HIGH(GPIOE_PIN0) | \
                                        ...
                                        PIN_OSPEED_HIGH(GPIOE_ARM_SUPPLY) | \
                                        PIN_OSPEED_HIGH(GPIOE_PIN3) | \
                                        PIN_OSPEED_HIGH(GPIOE_PIN4) | \
                                        PIN_OSPEED_HIGH(GPIOE_PIN5) | \
                                        PIN_OSPEED_HIGH(GPIOE_PIN6) | \
                                        PIN_OSPEED_HIGH(GPIOE_CH3_FIRE) | \
                                        PIN_OSPEED_HIGH(GPIOE_CH4_FIRE) | \
                                        PIN_OSPEED_HIGH(GPIOE_CH5_FIRE) | \
...
#define VAL_GPIOE_PUPDR                (PIN_PUPD_PULLUP(GPIOE_PIN0) | \
                                        ...
                                        PIN_PUPD_PULLDOWN(GPIOE_ARM_SUPPLY) | \
                                        PIN_PUPD_PULLUP(GPIOE_PIN3) | \
                                        PIN_PUPD_PULLUP(GPIOE_PIN4) | \
                                        PIN_PUPD_PULLUP(GPIOE_PIN5) | \
                                        PIN_PUPD_PULLUP(GPIOE_PIN6) | \
                                        PIN_PUPD_PULLDOWN(GPIOE_CH3_FIRE) | \
                                        PIN_PUPD_PULLDOWN(GPIOE_CH4_FIRE) | \
                                        PIN_PUPD_PULLDOWN(GPIOE_CH5_FIRE) | \
...
#define VAL_GPIOE_ODR                  (PIN_OD_HIGH(GPIOE_PIN0) | \
                                        ...
                                        PIN_OD_LOW(GPIOE_ARM_SUPPLY) | \
                                        PIN_OD_HIGH(GPIOE_PIN3) | \
                                        PIN_OD_HIGH(GPIOE_PIN4) | \
                                        PIN_OD_HIGH(GPIOE_PIN5) | \
                                        PIN_OD_HIGH(GPIOE_PIN6) | \
                                        PIN_OD_LOW(GPIOE_CH3_FIRE) | \
                                        PIN_OD_LOW(GPIOE_CH4_FIRE) | \
                                        PIN_OD_LOW(GPIOE_CH5_FIRE) | \
...
#define VAL_GPIOE_AFRL                 (PIN_AFIO_AF(GPIOE_PIN0, 0U) | \
                                        ...
                                        PIN_AFIO_AF(GPIOE_ARM_SUPPLY, 0U) | \
                                        PIN_AFIO_AF(GPIOE_PIN3, 0U) | \
                                        PIN_AFIO_AF(GPIOE_PIN4, 0U) | \
                                        PIN_AFIO_AF(GPIOE_PIN5, 0U) | \
                                        PIN_AFIO_AF(GPIOE_PIN6, 0U) | \
                                        PIN_AFIO_AF(GPIOE_CH3_FIRE, 0U))

#define VAL_GPIOE_AFRH                 (PIN_AFIO_AF(GPIOE_CH4_FIRE, 0U) | \
                                        PIN_AFIO_AF(GPIOE_CH5_FIRE, 0U) | \
